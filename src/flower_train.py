...
parser.add_argument('--data_root_dir', default="D:\pytorch_classeser\deep_learning_data", type=str,
                    help="path to your dataset")
args = parser.parse_args()
print(args)
args.data_root_dir = "D:\pytorch_classeser\deep_learning_data\oxfordflower102"
args.lr = 0.01
args.bs = None
